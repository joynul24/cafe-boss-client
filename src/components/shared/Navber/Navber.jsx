...
function Navber() {
  ...
  const NavItems = (
    <>
      ...
      <li className="bg-red-400 rounded-full flex items-center justify-center"><NavLink to="/">
        ...
        <>
          ...
          {user?.photoURL && (
            <li className="flex items-center justify-center">
              <div className="w-10 h-10 rounded-full border-2 border-amber-500 overflow-hidden p-0 flex items-center justify-center">
                <img
                  src={user?.photoURL}
                  alt="Profile"
